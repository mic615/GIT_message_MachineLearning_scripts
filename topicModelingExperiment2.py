...
bfout = '/home/mike/QA_Project/lda_Data/Bug_Fix_2topic_output/'
biout = '/home/mike/QA_Project/lda_Data/Bug_intro_2topic_output/'
bf_list= []
bi_list= []
total_list= []
...
topics=ldamodel.print_topics(num_topics=2, num_words=10)
for topic in topics:
	new_file.write(str(topic))
	new_file.write('\n')
